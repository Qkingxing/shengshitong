...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
	...
	F.prototype.config = {
			...
			if(i.startTime = (new Date).getTime(), a.url) {
				...
				d = JSON.stringify(d)
				a.contentType && 0 == a.contentType.indexOf("application/json") && (d ), i.loading(), t.ajax({
					type: a.method || "get",
					url:  i.handleUrl(a.url,d),
