		...
		var n, a = this,
			...
			u = function() {
				...
				layui.each(o, function(e, o) {
					var r = new FormData;
					r = l.handleData(o) || r.append(l.field, o), layui.each(l.data, function(e, t) {
					...
					var c = {
						...
						error: function(ew) {
							if(ew.status!=200){
								...
								i++, d(e, ew.responseText), u()
							}
						}
					};
					function ajaxsss(opt){
						t.ajax({
			...
			switch(l.accept) {
				...
				default:
					if(layui.each(v, function(e, t) {
							RegExp("\\w\\.(" + (h || "jpg|png|gif|pdf|bmp|jpeg$") + ")", "i").test(escape(t)) || (n = !0)
