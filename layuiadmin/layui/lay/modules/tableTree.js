layui.define(["laydate","laytpl","table","layer","tableEdit","form"],function(exports) {
    ...
    thisCss.push('.layui-tableEdit-span {position:absolute;left:25px;bottom:0;min-width:80%;}');
    ...
    TableTree.prototype = {
        ...
        ,addIcon:function(tr,td,lvl) {
            ...
            if(heightStyle === 'sl'){
                span.css('bottom','-1px');
                icon.css('bottom','-1px');
                update.css('bottom','6px');
                add.css('bottom','6px');
                remove.css('bottom','6px');
                sort.css('bottom','6px');
            }
...
//          var SPAN_SELECTOR = 'div.layui-table-cell';
